    ...
    <div class="options">
        ...
        <div class="options">
                ...
                <div class="inside">
                    ...
                    <form method="post" action="options.php" id="options">
                            ...
                            <div class="error">
                                ...
                                <table class="form-table">
                                    <tr valign="top">
                                        ...
                                        <td><input id="app_ID" type="text" name="fbcommentssync[app_ID]"
                                                   value="<?php echo $options['app_ID']; ?>" size="20"/><strong><a
                                                    href="https://developers.facebook.com/apps"
                                                    style="text-decoration:none; padding-left: 10px;" target="_blank">(Set
                                                    up your Facebook App ID)</a></strong>
                                            <br></td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <table class="form-table">
                            <?php if ($options['app_ID'] != "") { ?>
                                <tr valign="top">
                                    ...
                                    <td><input id="app_ID" type="text" name="fbcommentssync[app_ID]"
                                               value="<?php echo $options['app_ID']; ?>" size="20"/><strong><a
                                                href="https://developers.facebook.com/apps<?php if ($options['app_ID'] != "") {
                                                    echo "/" . $options['app_ID'] . "/summary";
                                                } ?>" style="text-decoration:none; padding-left: 10px;" target="_blank">(App
                                                Setttings)</a></strong></td>
                                </tr>
                            <?php } ?>
                            <tr valign="top">
                                <th scope="row"><label>Moderators:</label></th>
                                <td><input id="moderators" type="text" name="fbcommentssync[moderators]"
                                           value="<?php echo $options['moderators']; ?>" size="20"/><strong><a
                                            href="https://developers.facebook.com/tools/comments<?php if ($options['app_ID'] != "") {
                                                echo "?id=" . $options['app_ID'] . "&view=queue";
                                            } ?>" style="text-decoration:none; padding-left:10px;" target="_blank">Comment
                                            Moderation</a></strong><br>
                                    <small>By default, all admins to the App ID can moderate comments. To add
                                        moderators, enter each Facebook Profile ID by a comma <strong>without
                                            spaces</strong>. To find your Facebook User ID, click <a
                                            href="https://developers.facebook.com/tools/explorer/?method=GET&path=me"
                                            target="blank">here</a> where you will see your own. To view someone else's,
                                        replace "me" with their username in the input provided
                                    </small>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="form-table">
                            <tr valign="top">
                                <th scope="row">
                                    <input form="import_form" type="submit" name="" class="button-primary"
                                           value="Sync Comments"/>
                                </th>
                                <td id="synctext">
                            ...
                            jQuery(document).ready(function ($) {
                                ...
                                $('#import_form').submit(function () {
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: ajaxurl,
                                        data: {'action': 'fbcs_count'},
                                        success: function (response) {
                                            postcount = response / 10;
                                    ...
                                    function cevir(count) {
                                        $.ajax({
                                            type: 'POST',
                                            url: ajaxurl,
                                            data: {'action': 'fbcs_import', data: count},
                                            success: function (response) {
                                                $('#synctext').html('<small> <img src="<?php echo admin_url('/images/wpspin_light.gif'); ?>" class="waiting" /> ' + Math.round(response / postcount * 100) + '% synced... </small>');
                        ...
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                ...
                                <td><input id="fbjs" name="fbcommentssync[fbjs]" type="checkbox"
                                           value="on" <?php checked('on', $options['fbjs']); ?> />
                                    <small>If you already have XFBML enabled, disable this.</small>
                                </td>
                            </tr>
                            <tr valign="top">
                        ...
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                <th scope="row"><label for="homepage">Homepage</label></th>
                                <td><input id="home" name="fbcommentssync[homepage]" type="checkbox"
                                           value="on" <?php checked('on', $options['homepage']); ?> /></td>
                            </tr>
                            <tr valign="top">
                                ...
                                <td>
                                    <select name="fbcommentssync[language]">
                                        ...
                                        <option value="ar_AR" <?php selected($options['language'], 'ar_AR'); ?>>Arabic
                                        </option>
                                        ...
                                        <option value="cs_CZ" <?php selected($options['language'], 'cs_CZ'); ?>>Czech
                                        </option>
                                        <option value="cy_GB" <?php selected($options['language'], 'cy_GB'); ?>>Welsh
                                        </option>
                                        <option value="da_DK" <?php selected($options['language'], 'da_DK'); ?>>Danish
                                        </option>
                                        <option value="de_DE" <?php selected($options['language'], 'de_DE'); ?>>German
                                        </option>
                                        <option value="el_GR" <?php selected($options['language'], 'el_GR'); ?>>Greek
                                        </option>
                                        <option value="en_GB" <?php selected($options['language'], 'en_GB'); ?>>English
                                            (UK)
                                        </option>
                                        <option value="en_PI" <?php selected($options['language'], 'en_PI'); ?>>English
                                            (Pirate)
                                        </option>
                                        <option value="en_UD" <?php selected($options['language'], 'en_UD'); ?>>English
                                            (Upside Down)
                                        </option>
                                        <option value="en_US" <?php selected($options['language'], 'en_US'); ?>>English
                                            (US)
                                        </option>
                                        <option value="eo_EO" <?php selected($options['language'], 'eo_EO'); ?>>
                                            Esperanto
                                        </option>
                                        <option value="es_ES" <?php selected($options['language'], 'es_ES'); ?>>Spanish
                                            (Spain)
                                        </option>
                                        ...
                                        <option value="eu_ES" <?php selected($options['language'], 'eu_ES'); ?>>Basque
                                        </option>
                                        <option value="fa_IR" <?php selected($options['language'], 'fa_IR'); ?>>
                                            Persian
                                        </option>
                                        <option value="fb_LT" <?php selected($options['language'], 'fb_LT'); ?>>Leet
                                            Speak
                                        </option>
                                        ...
                                        <option value="fr_CA" <?php selected($options['language'], 'fr_CA'); ?>>French
                                            (Canada)
                                        </option>
                                        <option value="fr_FR" <?php selected($options['language'], 'fr_FR'); ?>>French
                                            (France)
                                        </option>
                                        <option value="fy_NL" <?php selected($options['language'], 'fy_NL'); ?>>
                                            Frisian
                                        </option>
                                        <option value="ga_IE" <?php selected($options['language'], 'ga_IE'); ?>>Irish
                                        </option>
                                        <option value="gl_ES" <?php selected($options['language'], 'gl_ES'); ?>>
                                            Galician
                                        </option>
                                        <option value="he_IL" <?php selected($options['language'], 'he_IL'); ?>>Hebrew
                                        </option>
                                        <option value="hi_IN" <?php selected($options['language'], 'hi_IN'); ?>>Hindi
                                        </option>
                                        ...
                                        <option value="km_KH" <?php selected($options['language'], 'km_KH'); ?>>Khmer
                                        </option>
                                        <option value="ko_KR" <?php selected($options['language'], 'ko_KR'); ?>>Korean
                                        </option>
                                        <option value="ku_TR" <?php selected($options['language'], 'ku_TR'); ?>>
                                            Kurdish
                                        </option>
                                        <option value="la_VA" <?php selected($options['language'], 'la_VA'); ?>>Latin
                                        </option>
                                        ...
                                        <option value="ms_MY" <?php selected($options['language'], 'ms_MY'); ?>>Malay
                                        </option>
                                        <option value="nb_NO" <?php selected($options['language'], 'nb_NO'); ?>>
                                            Norwegian (bokmal)
                                        </option>
                                        <option value="ne_NP" <?php selected($options['language'], 'ne_NP'); ?>>Nepali
                                        </option>
                                        <option value="nl_NL" <?php selected($options['language'], 'nl_NL'); ?>>Dutch
                                        </option>
                                        ...
                                        <option value="pl_PL" <?php selected($options['language'], 'pl_PL'); ?>>Polish
                                        </option>
                                        <option value="ps_AF" <?php selected($options['language'], 'ps_AF'); ?>>Pashto
                                        </option>
                                        ...
                                        <option value="sk_SK" <?php selected($options['language'], 'sk_SK'); ?>>Slovak
                                        </option>
                                        ...
                                        <option value="ta_IN" <?php selected($options['language'], 'ta_IN'); ?>>Tamil
                                        </option>
                                        <option value="te_IN" <?php selected($options['language'], 'te_IN'); ?>>Telugu
                                        </option>
                                        <option value="th_TH" <?php selected($options['language'], 'th_TH'); ?>>Thai
                                        </option>
                            ...
                            <tr valign="top">
                                <th scope="row"><label for="scheme">Colour Scheme</label></th>
                                <td>
                            ...
                            <tr valign="top">
                                <th scope="row"><label for="num">Number of Comments</label></th>
                                <td><input id="num" type="text" name="fbcommentssync[num]"
                                           value="<?php echo $options['num']; ?>"/>
                                    <small>default is <strong>5</strong></small>
                                </td>
                            </tr>
                            <tr valign="top">
                                <th scope="row"><label for="scheme">Comments Order</label></th>
                                <td>
                                    <select name="fbcommentssync[order]">
                            ...
                            <tr valign="top">
                                ...
                                <td><input id="width" type="text" name="fbcommentssync[width]"
                                           value="<?php echo $options['width']; ?>"/>
                                    <small>default is <strong>100%</strong>. Keep at this to ensure the comment box is
                                        responsive
                                    </small>
                                </td>
                            </tr>
                            <tr valign="top">
                                ...
                                <td><input id="title" type="text" name="fbcommentssync[title]"
                                           value="<?php echo $options['title']; ?>"/> with a CSS class of <input
                                        type="text" name="fbcommentssync[titleclass]"
                                        value="<?php echo $options['titleclass']; ?>"/> with a CSS id of <input
                                        type="text" name="fbcommentssync[titleid]"
                                        value="<?php echo $options['titleid']; ?>"/></td>
                            </tr>
                        </table>
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td><p>To manually adding comment box into any place in your website or override the default
                                    settings, you can use shortcodes.</p>
                                <ul>
                        ...
                        <tr valign="top">
                            ...
                            <td><p>For posts/pages (override):</p>
                                ...
                                <p><code>&lt;?php echo do_shortcode('[fbcommentssync url="http://btdogan.com"
                                        width="100%" num="5"]'); ?&gt;</code></p>
                        </tr>
                    </table>
            ...
            <div class="options_right">
                <div class="donation">
                    <a href="<?php echo FBCS_DONATE_LINK; ?>" target="_blank"><img class="paypal"
                                                                                   src="<?php echo plugins_url('images/paypal.gif', __FILE__); ?>"
                                                                                   width="150" height="50"></a>

                    <p>If you like this plugin, please help me building more open source projects with your donation.
                        Every cent counts, I appreciate your kindness.</p>
                </div>
...
add_action('wp_ajax_fbcs_count', 'fbcsf_postcount');
